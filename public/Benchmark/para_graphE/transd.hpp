...
public:
	...
	void save_to_file(string data_path, string relation) override {
		...
		file.open(data_path + "/" + relation + "_TransD_entity_vec.txt");
		...
		file.open(data_path + "/" + relation + "_TransD_relation_vec.txt");
		...
		file.open(data_path + "/" + relation + "_TransD_ent_proj_vec.txt");	
		file << entity_num << ' '  << embedding_dim << endl;
		...
		file.open(data_path + "/" + relation + "_TransD_rel_proj_vec.txt");			
		file << relation_num << ' ' << embedding_dim << endl;
