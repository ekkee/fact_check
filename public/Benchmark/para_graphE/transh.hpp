...
public:
	...
	void save_to_file(string data_path, string relation) override {
		...
		file.open(data_path + "/" + relation + "_TransH_entity_vec.txt");
		...
		file.open(data_path + "/" + relation + "_TransH_relation_vec.txt");
		...
		file.open(data_path + "/" + relation + "_TransH_project_vec.txt");
		file << relation_num << ' ' << embedding_dim << endl;
