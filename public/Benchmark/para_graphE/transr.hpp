...
public:
	...
	void init_from_file(string data_path, string relation) {	//TransR may need to initialized from TransE
		ifstream file;
		file.open(data_path + "/" + relation + "_TransR_entity_vec.txt");
		...
		file.open(data_path + "/" + relation + "_TransR_relation_vec.txt");
	...
	void save_to_file(string data_path, string relation) override {
		ofstream file;
		...
		file.open(data_path + "/" + relation + "_TransR_mat.txt");
	...
	void read_from_file(string data_path, string relation) override {	//used in test
		ifstream file;
		file.open(data_path + "/" + relation + "_TransR_entity_vec.txt");
		file >> entity_num >> embedding_dim;
		entity_vec.resize(entity_num);
