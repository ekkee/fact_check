...
int main(int argc, char **argv) {
	...
	string rel_name = spec["split"]["name"];
	exclude_relation_file ="../Extract_metadata/tmp_2.txt" ;
	...
	if (init_from_file == 0)
		...
		trans_ptr->init_from_file(data_path+"graphs/TransE_50_001");
	...
	//finalizing
	trans_ptr->save_to_file(data_path+"graphs/", spec["split"]["name"]);
